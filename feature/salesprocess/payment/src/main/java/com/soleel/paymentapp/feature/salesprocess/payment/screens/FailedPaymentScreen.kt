...
fun FailedPaymentScreen(
    ...
    val failedPaymentResult: PaymentResult by paymentViewModel.failedPaymentResult.collectAsStateWithLifecycle()

    failedPaymentResult.paymentId
    Column(
        ...
        content = {
            ...
            FailedPaymentScreenContent(
                ...
                onRetryPaymentMethod = { onRetryPaymentMethod(paymentViewModel.sale) },
